package tk.no5972.huascreenshot.models;
...
public class CdpRemoteWebDriver extends RemoteWebDriver {
	...
	public CdpRemoteWebDriver(URL remoteAddress, Capabilities capabilities) {
		super((CommandExecutor) (new HttpCommandExecutor(ImmutableMap.copyOf(CHROME_COMMAND_NAME_TO_URL),
